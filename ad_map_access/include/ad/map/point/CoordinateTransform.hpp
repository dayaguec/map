...
public: // ENU Reference Point Managment
   ...
   *  Be aware: when configured via the projection string, calls to setENUReferencePoint() will have no effect.
   * @param[in] geo_projection projection string for Geo<->ENU conversion
   */
...
public: // ENU/Geo Conversions
   ...
   * \note http://digext6.defence.gov.au/dspace/bitstream/1947/3538/1/DSTO-TN-0432.pdf
   */
...
public: // ECEF/ENU Conversions
         ...
         * @param[in] pt Source point.
         * @returns Point in the target coordinate system.
         * \note http://www.navipedia.net/index.php/Transformations_between_ECEF_and_ENU_coordinates
         */
...
public: // Useful methods
   ...
   * @returns The angle measured from center of Earth between a point and the equator.
...
private:                                              // Constants
  ...
  static constexpr double A6 = 9.9330562000986220e-1; ///< Precalculated constant.
