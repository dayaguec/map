...
lane::LaneDirection toLaneDirection(::opendrive::Lane const &lane, bool rightHandTraffic)
{
  lane::LaneDirection direction;

  // First determine the lane direction based on the position of the lane (right hand traffic)
  if (lane.index <= 0)
  {
    if (rightHandTraffic)
    {
